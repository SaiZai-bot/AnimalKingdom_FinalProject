...
// AddArticDelegate is a custom protocol so that Add Ocean view can tell this view when a new animal was added
class desertViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, AddDesertDelegate {
    ...
    // Gets and sets the shared AnimalData.shared.desertAnimals
